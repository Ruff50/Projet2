    ...
    ?>
        ...
        <div class="post">
            <div class="info-avatar">
                <img src=<?php echo  $post[15]["photo_avatar"]?> alt="pseudo" class="avatar">
                <div class="pseudo">
                <p class="title"><?php echo  $post[15]["title"]?></p>
                    <p class="post-time"><?php echo  $post[15]["post_time"]?></p>
                </div>
            </div>
            <div class="TitreArt">
            <p class="titre"><?php echo  $post[15]["titreart"]?></a></p>
            </div>
            <?php  
            if( $post[15]["image_article"] == '') 
            {
                echo '<br>' ;
            }  else 
            { 
                echo '<img src="'.  $post[15]["image_article"].'" alt="post_img" class="post-img"> ';
            }
           ?>

            <p class="post-text"><?php echo  $post[15]["post_text"]?></p>
            <div class="social">
                <p class="like"><span class="icon-thumbs-up-alt"></span><?php echo ' '.  $post[15]["polike"]?></p>
                <p class="comment"><span class="icon-comment-alt"></span><?php echo ' '. $post[15]["comments"]?></p>
            </div>
        </div>
